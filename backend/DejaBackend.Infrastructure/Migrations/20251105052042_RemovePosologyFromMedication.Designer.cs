...
namespace DejaBackend.Infrastructure.Migrations
{
    ...
    [Migration("20251105052042_RemovePosologyFromMedication")]
    partial class RemovePosologyFromMedication
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DejaBackend.Domain.Entities.AlertSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("CriticalStockChannels")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("CriticalStockEnabled")
                        .HasColumnType("bit");

                    b.Property<int>("CriticalStockThreshold")
                        .HasColumnType("int");

                    b.Property<string>("LowStockChannels")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("MedicationDelayChannels")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("MedicationDelayEnabled")
                        .HasColumnType("bit");

                    b.Property<int>("MedicationDelayMinutes")
                        .HasColumnType("int");

                    b.Property<string>("PrescriptionExpiryChannels")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("PrescriptionExpiryDefaultDays")
                        .HasColumnType("int");

                    b.Property<bool>("PrescriptionExpiryEnabled")
                        .HasColumnType("bit");

                    b.Property<bool>("QuietHoursEnabled")
                        .HasColumnType("bit");

                    b.Property<string>("QuietHoursEndTime")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("QuietHoursStartTime")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ReplenishmentRequestChannels")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("ReplenishmentRequestEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DejaBackend.Domain.Entities.AlertSettings", b =>
                {
                    b.HasOne("DejaBackend.Domain.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("DejaBackend.Domain.Entities.CaregiverSchedule", b =>
                {
                    b.HasOne("DejaBackend.Domain.Entities.Caregiver", "Caregiver")
                        .WithMany()
            ...
            modelBuilder.Entity("DejaBackend.Domain.Entities.Medication", b =>
                {
                    b.HasOne("DejaBackend.Domain.Entities.Prescription", null)
            ...
            modelBuilder.Entity("DejaBackend.Domain.Entities.MedicationPatient", b =>
                {
                    b.HasOne("DejaBackend.Domain.Entities.Medication", "Medication")
