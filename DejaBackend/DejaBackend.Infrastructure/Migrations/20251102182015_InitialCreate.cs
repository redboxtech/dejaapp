        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    IsSelfElderly = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TreatmentStartDate = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    TreatmentEndDate = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    HasTapering = table.Column<bool>(type: "INTEGER", nullable: false),
                    CurrentStock = table.Column<decimal>(type: "TEXT", nullable: false),
                    DailyConsumption = table.Column<decimal>(type: "TEXT", nullable: false),
                    DaysLeft = table.Column<int>(type: "INTEGER", nullable: false),
                    BoxQuantity = table.Column<decimal>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddedQuantity = table.Column<decimal>(type: "TEXT", nullable: true),
                    OwnerId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
